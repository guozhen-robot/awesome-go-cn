...
**This project is [awesome-go](https://awesome-go.com/) Chinese version, last sync time : 2019-12-10 09:56:36(Synchronize every day)**
...
* [oauth2](https://github.com/golang/oauth2) **star:2598** Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support.   [![star > 2000][Awesome]](https://github.com/golang/oauth2)   [![godoc][GoDoc]](https://godoc.org/github.com/golang/oauth2)
...
* [scs](https://github.com/alexedwards/scs) **star:626** Session Manager for HTTP servers.   [![godoc][GoDoc]](https://godoc.org/github.com/alexedwards/scs)
...
* [slackscot](https://github.com/alexandre-normand/slackscot) **star:18** Another framework for building Slack bots.   [![godoc][GoDoc]](https://godoc.org/github.com/alexandre-normand/slackscot)
...
* [cobra](https://github.com/spf13/cobra) **star:14918** Commander for modern Go CLI interactions.   [![star > 2000][Awesome]](https://github.com/spf13/cobra)   [![godoc][GoDoc]](https://godoc.org/github.com/spf13/cobra)
...
* [kingpin](https://github.com/alecthomas/kingpin) **star:2737** Command line and flag parser supporting sub commands.   [![star > 2000][Awesome]](https://github.com/alecthomas/kingpin)   [![godoc][GoDoc]](https://godoc.org/github.com/alecthomas/kingpin)
...
* [Dnote](https://github.com/dnote/dnote) **star:1348** A simple and end-to-end encrypted notebook for developers.   [![godoc][GoDoc]](https://godoc.org/github.com/dnote/dnote)
...
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) **star:2643** Go library for managing configuration data from environment variables.   [![star > 2000][Awesome]](https://github.com/kelseyhightower/envconfig)   [![godoc][GoDoc]](https://godoc.org/github.com/kelseyhightower/envconfig)
...
* [chproxy](https://github.com/Vertamedia/chproxy) **star:347** HTTP proxy for ClickHouse database.   [![godoc][GoDoc]](https://godoc.org/github.com/Vertamedia/chproxy)
...
* [rpcx](https://github.com/smallnest/rpcx) **star:4151** Distributed pluggable RPC service framework like alibaba Dubbo.   [![star > 2000][Awesome]](https://github.com/smallnest/rpcx)   [![godoc][GoDoc]](https://godoc.org/github.com/smallnest/rpcx)
...
* [afs](https://github.com/viant/afs) **star:19** Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go.   [![godoc][GoDoc]](https://godoc.org/github.com/viant/afs)
...
* [ants](https://github.com/panjf2000/ants) **star:2655** A high-performance goroutine pool for golang.   [![star > 2000][Awesome]](https://github.com/panjf2000/ants)   [![godoc][GoDoc]](https://godoc.org/github.com/panjf2000/ants)   [![Contains Chinese documents][CN]](https://github.com/panjf2000/ants)
...
* [onnx-go](https://github.com/owulveryck/onnx-go) **star:225** Go Interface to Open Neural Network Exchange (ONNX).   [![godoc][GoDoc]](https://godoc.org/github.com/owulveryck/onnx-go)
...
* [gobgp](https://github.com/osrg/gobgp) **star:1774** BGP implemented in the Go Programming Language.   [![godoc][GoDoc]](https://godoc.org/github.com/osrg/gobgp)
...
* [gev](https://github.com/Allenxuxu/gev) **star:716** gev is a lightweight, fast non-blocking TCP network library based on Reactor mode.   [![godoc][GoDoc]](https://godoc.org/github.com/Allenxuxu/gev)
...
* [heimdall](https://github.com/gojektech/heimdall) **star:1172** An enchanced http client with retry and hystrix capabilities.   [![godoc][GoDoc]](https://godoc.org/github.com/gojektech/heimdall)
...
* [gorp](https://github.com/go-gorp/gorp) **star:3246** Go Relational Persistence, ORM-ish library for Go.   [![star > 2000][Awesome]](https://github.com/go-gorp/gorp)   [![godoc][GoDoc]](https://godoc.org/github.com/go-gorp/gorp)
...
* [graphql-go](https://github.com/graphql-go/graphql) **star:5726** Implementation of GraphQL for Go.   [![star > 2000][Awesome]](https://github.com/graphql-go/graphql)   [![godoc][GoDoc]](https://godoc.org/github.com/graphql-go/graphql)
...
* [Cameradar](https://github.com/Ullaakut/cameradar) **star:1964** Tool and library to remotely hack RTSP streams from surveillance cameras.   [![godoc][GoDoc]](https://godoc.org/github.com/Ullaakut/cameradar)
...
* [Flagr](https://github.com/checkr/flagr) **star:951** Flagr is an open-source feature flagging and A/B testing service.   [![godoc][GoDoc]](https://godoc.org/github.com/checkr/flagr)
...
* Testing Frameworks
    ...
    * [endly](https://github.com/viant/endly) **star:114** Declarative end to end functional testing.   [![godoc][GoDoc]](https://godoc.org/github.com/viant/endly)
...
* [usql](https://github.com/knq/usql) **star:5473** usql is a universal command-line interface for SQL databases.   [![star > 2000][Awesome]](https://github.com/knq/usql)   [![godoc][GoDoc]](https://godoc.org/github.com/knq/usql)
...
* [realize](https://github.com/tockins/realize) **star:3408** Go build system with file watchers and live reload. Run, build and watch file changes with custom paths.   [![star > 2000][Awesome]](https://github.com/tockins/realize)   [![godoc][GoDoc]](https://godoc.org/github.com/tockins/realize)
* [goreporter](https://github.com/wgliang/goreporter) **star:2563** Golang tool that does static analysis, unit testing, code review and generate code quality report.   [![star > 2000][Awesome]](https://github.com/wgliang/goreporter)   [![It hasn't been updated in the last year][Yellow]](https://github.com/wgliang/goreporter)   [![godoc][GoDoc]](https://godoc.org/github.com/wgliang/goreporter)
...
* [validate](https://github.com/gobuffalo/validate) **star:26** This package provides a framework for writing validations for Go applications.   [![godoc][GoDoc]](https://godoc.org/github.com/gobuffalo/validate)
...
* [OctoLinker](https://github.com/OctoLinker/browser-extension) **star:4021** Navigate through go files efficiently with the OctoLinker browser extension for GitHub.   [![star > 2000][Awesome]](https://github.com/OctoLinker/browser-extension)   [![There was an update last week][Green]](https://github.com/OctoLinker/browser-extension)
...
* [Packer](https://github.com/mitchellh/packer) **star:9603** Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.   [![star > 2000][Awesome]](https://github.com/mitchellh/packer)   [![There was an update last week][Green]](https://github.com/mitchellh/packer)   [![godoc][GoDoc]](https://godoc.org/github.com/mitchellh/packer)
* [Hey](https://github.com/rakyll/hey) **star:7190** Hey is a tiny program that sends some load to a web application.   [![star > 2000][Awesome]](https://github.com/rakyll/hey)   [![godoc][GoDoc]](https://godoc.org/github.com/rakyll/hey)
...
* [bosun](https://github.com/bosun-monitor/bosun) **star:2902** Time Series Alerting Framework.   [![star > 2000][Awesome]](https://github.com/bosun-monitor/bosun)   [![godoc][GoDoc]](https://godoc.org/github.com/bosun-monitor/bosun)
...
* [kala](https://github.com/ajvb/kala) **star:1380** Simplistic, modern, and performant job scheduler.   [![godoc][GoDoc]](https://godoc.org/github.com/ajvb/kala)
...
* [Gor](https://github.com/buger/gor) **star:11972** Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.   [![star > 2000][Awesome]](https://github.com/buger/gor)   [![godoc][GoDoc]](https://godoc.org/github.com/buger/gor)
...
* [Stack Up](https://github.com/pressly/sup) **star:2039** Stack Up, a super simple deployment tool - just Unix - think of it like 'make' for a network of servers.   [![star > 2000][Awesome]](https://github.com/pressly/sup)   [![godoc][GoDoc]](https://godoc.org/github.com/pressly/sup)
...
* [borg](https://github.com/crufter/borg) **star:1446** Terminal based search engine for bash snippets.   [![It hasn't been updated in the last year][Yellow]](https://github.com/crufter/borg)   [![godoc][GoDoc]](https://godoc.org/github.com/crufter/borg)
...
* [go_serialization_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks) **star:923** Benchmarks of Go serialization methods.   [![godoc][GoDoc]](https://godoc.org/github.com/alecthomas/go_serialization_benchmarks)
